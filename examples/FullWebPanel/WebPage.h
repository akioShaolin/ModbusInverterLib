...
<body>
    ...
    <div class='wrap'>
        <div id="inverterConfig" class='status'></div>
        </div>
        <div class='grid'>
            <div class='card'>
                <h2>Identificação</h2>
            ...
            <div class='card'>
                ...
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='isBooted'><button
                        type='submit'>isBooted</button></form>
                <div id="isBooted" class='display small'>Aguardando leitura.</div>
            ...
            <div class='card'>
                ...
                <div class='danger'>
                    <form onsubmit="callSet(event, this)"><input type='hidden' name='fn' value='shutdown'><button
                        type='submit'>shutdown()</button></form>
                <div id="shutdown" class="display small">Aguardando comando.</div>
                </div>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn' value='setPowerFactor'><label>Valor
                        (PF)</label><input type='number' step='0.001' name='value' placeholder='0.98'><button
                        type='submit'>setPowerFactor</button></form>
                <div id="setPowerFactor" class="display small">Aguardando comando.</div>
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
            ...
            <div class='card'>
                ...
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='getDatetime'><button
                        type='submit'>getDatetime</button></form>
                <div id="getDatetime" class='display small'>Aguardando leitura.</div>
            ...
            <div class='card'>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn' value='setDatetime'>
                    ...
                    </div><button type='submit'>setDatetime</button>
                </form>
                <div id="setDatetime" class="display small">Aguardando comando.</div>
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        value='setYear'><label>Valor</label><input type='number' step='1' name='value'
                        placeholder='2026'><button type='submit'>setYear</button></form>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        ...
                        placeholder='1'><button type='submit'>setMonth</button></form>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        ...
                        placeholder='1'><button type='submit'>setDay</button></form>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        ...
                        placeholder='12'><button type='submit'>setHour</button></form>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        ...
                        placeholder='0'><button type='submit'>setMinute</button></form>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        ...
                        placeholder='0'><button type='submit'>setSecond</button></form>
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        ...
                        placeholder='1767225600'><button type='submit'>setEpochTime</button></form>
    ...
    <script>
        async function callGet(event, form) {
        ...
        async function loadConfig() {
                ...
                const text = await response.text();
                document.getElementById("inverterConfig").innerHTML = text;
        }
